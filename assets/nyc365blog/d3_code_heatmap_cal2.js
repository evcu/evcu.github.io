...
// *****************************************
    ...
    d3.eesur.heatmap = function module() {
        ...
        var dispatch = d3.dispatch('_hover','_click');
        ...
        function exports(_selection) {
            _selection.each(function(nestedData) {
                ...
                var years = d3.range(startYear, endYear).reverse(),
                    ...
                    sizeByDay = d3.min([sizeByYear/8,height/54]),
                ...
                var year = svg.selectAll('.year')
                    ...
                    .enter().append('g')
                        .attr('class', 'year')
                        .attr('transform', function(d,i) { return 'translate(' + i * sizeByYear + ',30)'; });

                year.append('text')
                    .attr({
                        class: 'year-title',
                        transform: 'translate(' + sizeByDay * 3.5 + ',-38)',
                        'text-anchor': 'middle',
                        'font-weight': 'bold'
                    })
                ...
                var rect = year.selectAll('.day')
                    ...
                    .enter().append('rect')
                        .attr({
                            ...
                            width: sizeByDay,
                            height: sizeByDay,
                            y: function(d) { return week(d) * sizeByDay; },
                            x: function(d) { return day(d) * sizeByDay; }
                        });
                ...
                var chartTitles = (function() {
                    ...
                    var titlesDays = svg.selectAll('.year')
                        ...
                        .attr('transform', function (d, i) {
                            return 'translate(' + sizeByDay*(i+1) + ',-5)rotate(90)';
                        });
                    ...
                    var titlesMonth = svg.selectAll('.year')
                        ...
                        .enter().append('g')
                            ...
                            .attr('transform', function (d, i) { 
                                return 'translate(-5,' + (((i+1) * (width/12) )-30) + ')'; 
                            });
